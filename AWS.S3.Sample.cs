...
namespace AmazonS3Sample
{
    class S3Sample
    {
        ...
        static string bucketName = ""; // Bucket name here
        static string keyName = "";    // Sample object key
        static string keyContainerName = "S3SampleKeyContainer";

        static string accessKey = ""; 
        static string secretKey = ""; // S3 user public/private keys
        ...
        public async static Task Test()
        {
            if (checkRequiredFields())
            {
                ...
                using (client = new AmazonS3EncryptionClient(new Amazon.Runtime.BasicAWSCredentials(accessKey, secretKey), RegionEndpoint.EUWest1, new EncryptionMaterials(key)))                
                {
                    ...
                    await WritingAnObject();

                    Console.WriteLine("Reading an object");
                    await ReadingAnObject();

                    Console.WriteLine("Deleting an object");
                    await DeletingAnObject();

                    Console.WriteLine("Listing objects");
                    await ListingObjects();
                }
        ...
        static async Task ListingBuckets()
        {
            try
            {
        ...
        static async Task CreateABucket()
        {
            try
            {
        ...
        static async Task WritingAnObject()
        {
            try
            {
                // simple object put
        ...
        static async Task ReadingAnObject()
        {
            try
            {
        ...
        static async Task DeletingAnObject()
        {
            try
            {
        ...
        static async Task ListingObjects()
        {
            try
            {
